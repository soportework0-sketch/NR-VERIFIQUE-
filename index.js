...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .setDescription("Retira la verificación de un usuario.")
    ...
    new SlashCommandBuilder()
        .setName("reverificar")
        .setDescription("Obliga a un usuario a volver a verificarse.")
        .addUserOption(option =>
            option
                .setName("usuario")
                .setDescription("Usuario.")
    ...
    new SlashCommandBuilder()
        .setName("estado")
        .setDescription("Consulta el estado de verificación.")
        .addUserOption(option =>
            option
                .setName("usuario")
                .setDescription("Usuario.")
    ...
    new SlashCommandBuilder()
        .setName("help")
        .setDescription("Muestra la guía de NR VERIFIQUE."),
...
client.once("ready", () => {
    ...
    console.log("====================================");
    console.log("🛡️ NR VERIFIQUE ONLINE");
    console.log("====================================");
    ...
    console.log("⚙️ +10 bots en funcionamiento");
...
client.on("guildCreate", async guild => {
    ...
    const embed = new EmbedBuilder()
        ...
        .setColor(0x5865F2)
        .setFooter({
            text: "NR VERIFIQUE • Configuración inicial"
        })
        .setTimestamp();
    ...
    try {
        ...
        console.log("📩 Configuración enviada por DM.");
...
client.on("interactionCreate", async interaction => {
    ...
    try {
        ...
        if (
            ...
            interaction.customId === "select_language"
        ) {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    ...
                    "para comenzar a configurar el sistema."
                )
                .setColor(0x57F287)
                .setFooter({
                    text: "NR VERIFIQUE"
        ...
        /* =====================================
           COMANDO SETUP IDIOMA
        ===================================== */

        if (
            interaction.commandName === "setup" &&
            interaction.options.getSubcommand() === "idioma"
        ) {
        ...
        if (
            command === "setup" &&
            interaction.options.getSubcommand() === "verificacion"
        ) {
        ...
        if (command === "desverificar") {
            ...
            return interaction.reply(
                `✅ Se retiró la verificación de **${user.tag}**.`
            );
        }
        ...
        if (command === "reverificar") {
            ...
            return interaction.reply({
                content:
                    `🔄 **${user.tag}** debe volver a realizar la verificación.`,
                ephemeral: true
            });
        }
...
async function start() {
    ...
    if (!CLIENT_ID) {
        console.error(
            "❌ Falta la variable CLIENT_ID en Render."
        );
        process.exit(1);
    }
